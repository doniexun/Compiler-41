...
learn the concept and implement it in your way but copying as its is
is plagiarism.
...
//---------------------------------------------------------
// Data structures:
// Inclusions and modifications, author: ravs

struct varNode
{
	int var_type; //primary 0; or array 1
	struct primaryVarNode* primary_node;
	struct arrayVarNode* array_node;
...
struct primaryVarNode{
	char* name;
	int value;
};

struct exprNode{
	int operator; //PLUS or MULT or 0
	int tag; //0 varNode or 1 exprNode
